...
// Package refutil contains some reflection utils.
package refutil
...
func IsStruct(src interface{}) bool {
	return reflect.TypeOf(src).Kind() == reflect.Struct
}

func IsStructPtr(src interface{}) bool {
